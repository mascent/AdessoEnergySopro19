...
Die Soll-Features sind Erweiterungen der Grundfunktionene oder stellen Verbesserungen bzw. Änderungen an diesen dar.
\begin{itemize}
\item \textbf{Bearbeitungs-requests} \hfill \\
Sobald ein*e Nutzer*inn eine nachträgliche Änderung eines eingetragenen 
Zählerstandes durchführen möchte, ist es möglich eine Anfrage (Request) an einen Admin zu stellen, welcher diese Anfrage
überprüft.
\item \textbf{Requests annehmen} \hfill \\
	Bearbeitungsanfragen werden Admins in der Website angezeigt, damit sie diese überprüfen und annehmen können.
...
\item \textbf{Mehrere Zähler}\hfill \\
	Einem Account können mehrere Zähler gleicher Art zugeordnet werden. % TODO Fragestunden 
\item \textbf{Rollen weiter aufteilen}\hfill \\
	Die Adminrechte werden in IT-Support und Administration aufgeteilt, um die Zugriffsrechte sinnvoll aufzuteilen.
...
\item \textbf{Statistiken}
	Die Adminrechte können auf die durchschnittlichen oder spezifische Verbrauchs- und Zählerstatistiken zugreifen.
