...
\begin{table}[h]
	...
	\begin{tabularx}{\textwidth}{X X}
		...
		Web-Applikation: Web-Applikation beinhaltet nicht den Server. Aufgrund der umfassenden React-Architektur betrachten wir die Website als eigene Applikation.
